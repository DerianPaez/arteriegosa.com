  ...
  return (
    <TermsStyled>
      <Section className="terms">
        ...
        <ul>
          <li>
            <p><strong>Afiliado</strong> significa una entidad que controla, es controlada o está bajo control común con una parte, donde "control" significa la propiedad del 50% o más de las acciones, participación accionaria u otros valores con derecho a voto para la elección de directores u otra autoridad administrativa.</p>
          </li>
          <li>
            <p><strong>País</strong> se refiere a: Ecuador</p>
          </li>
          <li>
            <p><strong>Compañia</strong> (referida como "la Empresa", "Nosotros", "Nos" o "Nuestro" en este Acuerdo) se refiere a ArteRiego</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Los Términos y condiciones</strong> (también denominados "Términos") significan estos Términos y condiciones que forman el acuerdo completo entre Usted y la Compañía con respecto al uso del Servicio.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>El sitio web</strong> se refiere a Tour Etec, accesible desde <a href="https://www.arteriegosa.com" rel="external nofollow noopener" target="_blank">https://www.arteriegosa.com</a></p>
          </li>
          <li>
