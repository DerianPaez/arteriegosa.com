    ...
    <PrivacyStyled>
      <Section className="privacy">
        ...
        <Paragraph>
          ...
          Al utilizar el Servicio, acepta la recopilación y el uso de
        ...
        <ul>
          ...
          <li>
            <Paragraph>
              <strong>Compañía</strong> (denominado "la Compañía", "Nosotros",
              "Nos" o "Nuestro" en este Acuerdo) se refiere a ArteRiego
            </Paragraph>
          </li>
          <li>
            <Paragraph>
              <strong>Cookies</strong> Las cookies son pequeños archivos que un
          ...
          <li>
            <Paragraph>
              ...
              Compañía. Se refiere a empresas de terceros o personas empleadas
          ...
          <li>
            <Paragraph>
              <strong>Sitio web</strong> se refiere a ArteRiego, accesible desde{' '}
              <a
        ...
        <Paragraph>
          ...
          que pasó en esas páginas, el dispositivo único identificadores y otros
        ...
        <Paragraph>
          ...
          móvil, su dispositivo móvil sistema operativo, el tipo de navegador de
          Internet móvil que utiliza, identificadores de dispositivo únicos y
        ...
        <ul>
          <li>
            <Paragraph>
              ...
              pequeño archivo que se coloca en su dispositivo. Puede indicarle a
              su navegador que rechace todas las cookies o que indique cuándo se
              está enviando una cookie. Sin embargo, si no acepta las cookies,
          ...
          <li>
            <Paragraph>
              <strong>Flash Cookies.</strong> Ciertas características de nuestro
              Servicio pueden usar objetos almacenados localmente (o Cookies
              Flash) para recopilar y almacenar información sobre Sus
              preferencias o Su actividad en nuestro Servicio. Las cookies de
              Flash no se administran con la misma configuración del navegador
              que las utilizadas para las cookies del navegador. Para obtener
              más información sobre cómo puede eliminar las cookies de Flash,
              lea "¿Dónde puedo cambiar la configuración para deshabilitar o
              eliminar objetos compartidos locales?" disponible en{' '}
              <a
          ...
          <li>
            <Paragraph>
              ...
              denominados gifs transparentes, etiquetas de píxeles y gifs de un
              solo píxel) que permiten a la Compañía, por ejemplo, contar los
              usuarios que han visitado esas páginas. o abrió un correo
              electrónico y para otras estadísticas del sitio web relacionadas
              (por ejemplo, registrar la popularidad de una determinada sección
        ...
        <ul>
          <li>
            ...
            <Paragraph>
              ...
              usuario. Sin estas cookies, los servicios que ha solicitado no se
              pueden proporcionar, y solo usamos estas cookies para brindarle
              esos servicios.
            </Paragraph>
          </li>
          <li>
          ...
          <li>
            <Paragraph>
              <strong>Funcionalidad de las Cookies</strong>
            </Paragraph>
            <Paragraph>Tipo: Cookies persistentes</Paragraph>
            <Paragraph>Administrado por: Nosotros</Paragraph>
            <Paragraph>
              Propósito: estas cookies nos permiten recordar las elecciones que
              realiza cuando utiliza el sitio web, como recordar sus datos de
              inicio de sesión o su preferencia de idioma. El propósito de estas
              cookies es brindarle una experiencia más personal y evitar que
              tenga que volver a ingresar sus preferencias cada vez que utiliza
              el sitio web.
            </Paragraph>
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <Paragraph>
              ...
              artículos o servicios que haya comprado o de cualquier otro
          ...
          <li>
            <Paragraph>
              <strong>Para proporcionarle noticias</strong>, ofertas especiales
              e información general sobre otros bienes, servicios y eventos que
              ofrecemos y que son similares a los que ya ha comprado o sobre los
              que ha consultado, a menos que haya optado por no recibir dicha
              información.
            </Paragraph>
          </li>
          <li>
            <Paragraph>
              ...
              gestionar sus solicitudes para nosotros.
            </Paragraph>
          </li>
          <li>
            <Paragraph>
              <strong>Para transferencias comerciales:</strong> podemos usar su
              ...
              transferencia de algunos o todos nuestros activos, ya sea como
              empresa en funcionamiento o como parte de una quiebra,
          ...
          <li>
            <Paragraph>
              ...
              para otros fines, como análisis de datos, identificación de
              tendencias de uso, determinación de la eficacia de nuestras
        ...
        <ul>
          ...
          <li>
            <Paragraph>
              ...
              de la Compañía, financiamiento o adquisición de la totalidad o una
              parte de Nuestro negocio a otra compañía.
            </Paragraph>
          </li>
          <li>
            <Paragraph>
              <strong>Con afiliados:</strong> podemos compartir su información
              con nuestros afiliados, en cuyo caso les exigiremos que cumplan
              con esta Política de privacidad. Los afiliados incluyen nuestra
              empresa matriz y cualquier otra subsidiaria, socios de empresas
              conjuntas u otras empresas que controlemos o que estén bajo
          ...
          <li>
            <Paragraph>
              <strong>Con otros usuarios:</strong> cuando comparte información
              personal o interactúa de otra manera en las áreas públicas con
        ...
        <Paragraph>
          ...
          interno. Los datos de uso generalmente se conservan durante un período
          ...
          servicio, o estamos legalmente obligados a conservar estos datos
        ...
        <Paragraph>
          Se le aconseja que revise esta Política de privacidad periódicamente
